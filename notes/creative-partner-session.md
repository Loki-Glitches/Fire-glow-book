...
- **Still open:** The optional concussion beat (not addressed; left optional). Whether the brothers own phones: the author only said there's no way to contact them, so the paragraph says no numbers were swapped and doesn't claim they have no phones.
