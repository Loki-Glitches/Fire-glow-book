...
- A new postcard appears on the fridge, postmarked/pictured London (red phone booth image), added to a small existing collection already on the fridge under one magnet. Message on the back is short and unsigned; Sam says that's the entire content, no further explanation given on-page. **Author's note/assumption flagged:** the sender's identity is deliberately left unspecified — no name, relationship, or explanation was given in the author's outline, so none was invented. This is a loose thread for a future chapter or the Director to resolve, not something this chapter treats as suspicious — it reads as routine, recurring correspondence.
