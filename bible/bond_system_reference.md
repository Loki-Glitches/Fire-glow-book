...
**Conditions:** Lucifer must explain that he is divine AND what his mission is on Earth (that he is looking for someone — a name isn't required for the condition itself, and per the purity/truth constraint he cannot claim to lack one if he has it). **"Arrival" (author's direct edit, 2026-09-05): he actually names her — "Her name is Eve, but the name itself won't do you any good" — to James and Claire.** "Park" originally used a more withheld version with Elizabeth ("I have a name, but it wouldn't do you any good — she won't be using it"), which created a divergence (James/Claire knew the name, Elizabeth didn't) — **closed as of "Rhythm" (2026-09-05): Lucifer tells Elizabeth the name "Eve" too, landed casually in the background of an otherwise-forthcoming night, not as a staged reveal.** Both disclosure halves (divine + mission) are required — not just one. **Sequencing matters: no ability display of any kind before both halves are actually disclosed, even within the same scene (corrected 2026-09-05 — "Arrival"'s ring reshape originally happened before the mission was disclosed, which isn't valid; fixed by reordering).**
