...
**Habit: eating apples (added 2026-09-19).** A small, constant physical tic, distinct from the Tree of Knowledge fruit thread (see ORIGIN/BACKSTORY and `bible/story-bible.md` § "Planted Threads") — this is about ordinary apples, not that specific fruit. He eats them casually, often, simply because he likes them, and it functions as self-regulation: something to do with his hands and mouth that manages anger and boredom in the moment, in lieu of actually addressing either. Expect him holding, eating, or destroying an apple in mundane, low-stakes scenes throughout — this is texture, not plot, and should show up often, especially in Act One/early Act Two while he's at his most volatile. **He cannot just set one down once he's picked it up — he has to either eat it or destroy it.** There's no clean, idle way for him to hold an apple and walk away from it. This is a compulsion, not a preference, and doesn't need to be explained or remarked on by him or anyone else — just consistently true. As his arc softens, this habit can naturally show up less or read as less urgent, though the author hasn't locked an explicit fade-out point.
